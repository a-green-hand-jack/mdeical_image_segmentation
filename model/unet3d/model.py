...
from model.unet3d.buildingblocks import (
    DoubleConv,
    ResNetBlock,
    ResNetBlockSE,
    create_decoders,
...
from model.unet3d.utils import get_class, number_of_features_per_level
...
class AbstractUNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # 这里注释掉关于激活函数的部分，我这里不想得到sigmoid，只想得到logits
...
def get_model(model_config):
    model_class = get_class(model_config["name"], modules=["model.unet3d.model"])
